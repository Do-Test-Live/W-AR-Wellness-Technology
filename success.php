...
$insert = $db_handle->insertQuery("INSERT INTO `success_order`(`inserted_at`) VALUES ('$date')");
?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8">
    ...
    <title>Success | AR Wellness Communication Technology</title>
    <!-- Standard Favicon -->
        ...
        <div class="row gy-5 align-items-center">
            <div class="col-md-12">
                <div class="right-content-about">
                    <div class="sec-title">
                        <h2 class="tag1 text-center text-success">Your Payment has been Successful.</h2>
                    </div>
